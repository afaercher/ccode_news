...
> Letzte Aktualisierung: 2026-09-08 12:00 UTC (**Crawl 08.09. 12:00 UTC — achter Lauf in Folge ohne Bewegung; gemessen in Arbeitszeit ist die Pause aber erst fünf Stunden alt.** Alle vier Quellen sind byte-identisch zum Vorlauf. Die CLI steht unverändert auf **v2.1.263** (npm-Publish 06.09. 02:07:58 UTC, GitHub-Release 02:54:20 UTC); ein **v2.1.264 gibt es nicht** — die npm-Version antwortet HTTP **404**, ebenso die Git-Refs `v2.1.264`, `v2.1.265` und `v2.1.266`; `time.modified` steht weiterhin auf 06.09. **02:53:41 UTC**, die Tags sind still (`latest` = `next` = **2.1.263**, `stable` unverändert **2.1.236**). `CHANGELOG.md` ist byte-identisch zu den sieben Vorläufen (**630840 Bytes**), die Releases-API listet deckungsgleich v2.1.263 an der Spitze (60-Byte-Platzhalter-Body, `ashwin-ant`). `v2.1.262` bleibt HTTP **404**. Die Lücke seit dem letzten Publish beträgt **57,9 Stunden**. **Fund dieses Laufs — Kalenderzeit ist das falsche Lineal für diese Pause:** Rechnet man die 57,9 Stunden in *Arbeitszeit* um, also nur Stunden auf US-Werktagen (Wochenende und Bundesfeiertage herausgenommen), bleiben davon **5,0 Stunden** übrig — v2.1.263 kam Samstagabend 19:07 PT, danach folgten Sonntag, der Labor-Day-Montag und erst seit Dienstag 00:00 PT läuft die Uhr wieder. Nach Kalenderzeit liegt die aktuelle Pause im oberen Zehntel (**26 von 225** Lücken des Jahres 2026 sind ≥ 57,9 h, **12 %**), nach Arbeitszeit ist sie **unauffälliger als 88 %** aller Lücken (199 von 225 sind länger als 5,0 h). Der Maßstabswechsel schrumpft die Streuung drastisch: Kalender-Lücken 2026 haben Median **22,5 h** und p90 **68,0 h** (Faktor 3,0), Arbeitszeit-Lücken Median **20,2 h** und p90 **26,5 h** (Faktor 1,3). **Praktisch entscheidend ist die Alarmschwelle:** Von den **28 Kalender-Lücken ≥ 48 h** des Jahres 2026 überschreiten nur **3** auch in Arbeitszeit 48 Stunden — eine 48-Stunden-Schwelle auf der Wanduhr feuert also 28-mal im Jahr und trifft in **11 %** der Fälle etwas Echtes, dieselbe Schwelle auf Arbeitszeit feuert **3-mal** und jedes Mal zu Recht (Weihnachtspause 22.12.–06.01. mit 192,5 Arbeitsstunden, die leere Woche 31 vom 24.07.–03.08. mit 143,1, und 20.–24.03. mit 48,8). Die übrigen 25 sind reine Wochenend- und Feiertagsartefakte; in ihnen stecken im Median **24,0 Arbeitsstunden**, also genau eine gewöhnliche Lücke. **Prognose, diesmal mit getrennt geschätzter Ausfallrate:** Von den 9 Dienstagen seit dem 01.07.2026 hatten **8 einen Publish** (89 %, leer blieb nur der 28.07. — mitten in der leeren Woche 31), und der jeweils erste Publish des Dienstags lag ausnahmslos zwischen **10:15 und 13:37 PT**, Median **12:17 PT**. Erwartet wird v2.1.264 also heute zwischen **17:15 und 20:37 UTC**, Schwerpunkt **19:17 UTC** — zum jetzigen Lauf (12:00 UTC = **05:00 PT**) ist das Fenster noch **fünf Stunden entfernt**, die Prognose damit weder bestätigt noch widerlegt; die Entscheidung fällt beim 18:00-Lauf, sicher sichtbar erst am Mittwoch 06:00. **What's New** ist byte-identisch (**14051 Bytes**), oben weiterhin **Week 34**; `2026-w35`, `-w36` und `-w37` antworten HTTP **404**, der reale Digest-Rückstand bleibt **zwei Wochen** (W35, W36). **Platform** ist byte-identisch (**103914 Bytes**) über `…/release-notes/overview.md`, oben unverändert der **03.09.** (`ant`-CLI 1.30.0), darunter der Block vom 01.09. zu Fable 5.1/Mythos 5.1. **Blog** ist byte-identisch (**763730 Bytes**), fünfzehn Slugs unverändert, der `Last Published`-Stempel steht den **zehnten Lauf in Folge** auf **03.09. 17:24 UTC**. Alle vier Quellen plus npm-Registry, Releases-API und Git-Refs per `curl -L --retry 2` im ersten Versuch, keine leeren Antworten. **Neue Einträge: 1** (Kalenderzeit gegen Arbeitszeit als Maßstab für Release-Pausen). — Vorheriger **Crawl 08.09. 06:00 UTC — siebter Lauf in Folge ohne Bewegung; die Montags-Prognose ist widerlegt, und der Grund ist der Kalender.** Alle vier Quellen sind byte-identisch zum Vorlauf. Die CLI steht unverändert auf **v2.1.263** (npm-Publish 06.09. 02:07:58 UTC, GitHub-Release 02:54:20 UTC); ein **v2.1.264 gibt es nicht** — die npm-Version antwortet HTTP **404**, ebenso die Git-Refs `v2.1.264` und `v2.1.265`; `time.modified` steht weiterhin auf 06.09. **02:53:41 UTC**, die Tags sind still (`latest` = `next` = **2.1.263**, `stable` unverändert **2.1.236**). `CHANGELOG.md` ist byte-identisch zu den sechs Vorläufen (**630840 Bytes**), die Releases-API listet deckungsgleich v2.1.263 an der Spitze (60-Byte-Platzhalter-Body, `ashwin-ant`). `v2.1.262` bleibt HTTP **404**. Die Lücke seit dem letzten Publish beträgt **51,9 Stunden**. **Die Prognose der letzten drei Läufe ist damit widerlegt:** Das benannte Fenster (Montag 07.09., **17:00–22:30 UTC**) ist vollständig verstrichen, ohne dass etwas publiziert wurde — der ganze Montag blieb leer. **Fund dieses Laufs — an US-Feiertagen wird nicht ausgeliefert, und genau das hat die Prognose übersehen:** Der 07.09.2026 ist **Labor Day**, der erste Montag im September und ein US-Bundesfeiertag. Prüft man alle **20 auf einen Werktag fallenden US-Bundesfeiertage** seit Februar 2025 gegen die Publish-Historie, blieben **17 davon ohne einen einzigen Publish (85 %)** — gegenüber einer Grundrate von **20 leeren Tagen unter 178 Werktagen** des Jahres 2026 (**11 %**). Die längste Lücke der gesamten Historie, **336,5 Stunden** ab dem 22.12.2025, deckt exakt Weihnachten bis Neujahr ab. Nur drei Werktags-Feiertage hatten einen Publish (Labor Day 2025, Presidents Day 2026, der auf Freitag vorgezogene 4. Juli 2026). **Damit erklärt sich auch, warum die alte Prognose danebenlag: Sie beruhte auf Selektionsbias.** Sie hatte nur die Uhrzeiten jener Montage ausgewertet, an denen überhaupt publiziert wurde, und dabei übersehen, dass der **Montag der Werktag mit der höchsten Ausfallquote** ist — **7 von 36 Montagen** in 2026 ohne Publish (19 %) gegen **2 von 35** bei Dienstag und Mittwoch (6 %); **drei der sieben leeren Montage sind Feiertage** (MLK 19.01., Memorial Day 25.05., Labor Day 07.09.). **Neue Prognose für v2.1.264:** Nach einem leeren Feiertags-Montag kam der Anschluss dreimal am **Dienstag** (14.10.2025 10:18 PT, 20.01.2026 14:37 PT, 26.05.2026 14:38 PT), einmal am Mittwoch, einmal erst in der Folgewoche. Der erste Dienstags-Publish liegt seit 01.07. ausnahmslos zwischen **10:15 und 13:37 PT** (17:15–20:37 UTC), im Median 11:50 PT. Erwartung also: **Dienstag 08.09. zwischen etwa 17:00 und 21:00 UTC** — der 18:00-Lauf erwischt den Anfang des Fensters, verlässlich sichtbar wird die Version beim Lauf am Mittwoch 06:00. **What's-New** byte-identisch (**14051 Bytes**), Week 34 (17.–21.08.) weiterhin oben, `w35`, `w36` und `w37` antworten HTTP **404**; der reale Digest-Rückstand bleibt **zwei Wochen** (W35, W36). **Platform-Release-Notes** byte-identisch (**103914 Bytes**) über `…/release-notes/overview.md`; Top-Eintrag weiter **03.09.** (`ant`-CLI 1.30.0 mit `ant apply`), darunter unverändert der Block vom 01.09. zu Claude Fable 5.1 und Mythos 5.1. **Blog** byte-identisch (**763730 Bytes**), dieselben fünfzehn Slugs in gleicher Reihenfolge; der `Last Published`-Stempel steht den **neunten Lauf in Folge** auf **03.09. 17:24 UTC**. Alle vier Quellen plus npm-Registry, Releases-API und Git-Refs per `curl -L --retry 2` im ersten Versuch, keine leeren Antworten. **Neue Einträge: 1** (Feiertagspause und widerlegte Montags-Prognose). — Ältere Crawl-Historie in den Git-Commits.)
