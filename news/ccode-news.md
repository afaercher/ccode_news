...
> Letzte Aktualisierung: 2026-08-24 06:00 UTC (Crawl 24.08. 06:00 UTC — **Der tägliche Release-Rhythmus ist gebrochen: Der 23.08. blieb komplett ohne npm-Release.** Die npm-Registry zeigt als jüngsten Publish unverändert **v2.1.241 vom 22.08. 23:58 UTC** — zwischen diesem Zeitpunkt und dem Crawl um 06:00 UTC am 24.08. (30 Stunden) erschien nichts, auch kein spätes Sonntags-Release. Damit endet die Serie täglicher Releases nach sechs Tagen (17.–22.08., mit zwei Releases am 22.08.); der 23.08. war ein **Sonntag**, und v2.1.241 kam Samstagabend Westküstenzeit — die naheliegende Lesart ist eine Wochenend-Pause, keine Rhythmus-Änderung. **Ob der Werktags-Rhythmus hält, zeigt erst der weitere Montag (24.08.)**: 06:00 UTC entspricht 23:00 Sonntagabend an der US-Westküste, für den Montag ist also noch nichts zu erwarten gewesen. **CLI unverändert v2.1.241**, oberstes GitHub-Release unverändert v2.1.241 (23.08. 00:52 UTC), Tags still: `latest` und `next` einheitlich **2.1.241**, `stable` unverändert **2.1.231**. **Changelog-Endstand bestätigt:** `CHANGELOG.md` und GitHub-Release-Bodies zu v2.1.241 und v2.1.240 unverändert je einzeilig („Bug fixes and reliability improvements“) — wie am 23.08. festgehalten kein weiteres Nachfassen nötig. **What’s New unverändert**: Week 34 oben, Week 33 darunter, beide vollständig in dieser Datei; nächster fälliger Digest wäre **Week 35** (24.–28.08.), frühestens Ende dieser Woche. Week 31 fehlt weiterhin (Sprung Week 32 → Week 30). **Blog-Top unverändert 21.08.** („Bringing the cybersecurity capabilities of Claude Mythos 5 to more defenders“), exakt dieselben fünfzehn Slugs wie am 23.08., kein Beitrag vom 22.–24.08. **Platform-Top unverändert 20.08.** (Python-SDK 1.0), kein Eintrag vom 21.–24.08. **Quellenlage:** npm, GitHub-Releases-API, `CHANGELOG.md`, `code.claude.com` und die Blog-Slug-Liste alle per `curl -L --retry 3` im ersten Versuch; `platform.claude.com` weiterhin nur per WebFetch auf `…/docs/en/release-notes/overview`. **Keine neuen Einträge**; der älteste Crawl-Block (23.08. 12:00) aus dem Header in die Git-Historie ausgelagert. — Vorheriger Crawl 23.08. 18:00 UTC — **Zweiter Bestätigungs-Crawl des Tages, erneut ohne jede Bewegung in allen vier Quellen.** **Die CLI bleibt bei v2.1.241** (npm-Publish 22.08. 23:58 UTC, GitHub-Release 23.08. 00:52 UTC) — **kein v2.1.242 bis 18:00 UTC**, `latest` und `next` einheitlich **2.1.241**, `stable` unverändert **2.1.231**. Damit ist der 23.08. bis 18:00 UTC (11:00 US-Westküste) **der erste Tag seit dem 17.08. ohne npm-Release**; die Vorgänger kamen zwischen 13:03 und 23:58 UTC, ein spätes Release ist also weiter möglich — erst der 06:00-Crawl am 24.08. kann den siebentägigen Rhythmus (17.–23.08.) als gebrochen oder gehalten einordnen. Zu beachten: Der 23.08. ist ein Sonntag, und v2.1.241 wurde Samstagabend Westküstenzeit veröffentlicht. **Changelog weiterhin einzeilig:** `CHANGELOG.md` und GitHub-Release-Bodies zeigen zu v2.1.241 und v2.1.240 unverändert nur „Bug fixes and reliability improvements“ — Endstand bestätigt, kein weiteres Nachfassen. **What’s New unverändert** Week 34 oben, Week 33 darunter, Week 31 weiterhin fehlend (Sprung Week 32 → Week 30). **Blog-Top unverändert 21.08.**, exakt dieselben fünfzehn Slugs wie um 12:00 UTC, kein neuer Beitrag. **Platform-Top unverändert 20.08.** (Python-SDK 1.0), kein Eintrag vom 21.–23.08. **Quellenlage:** npm, GitHub-Releases-API, `CHANGELOG.md`, `code.claude.com` und die Blog-Slug-Liste diesmal alle per `curl -L --retry 3` im ersten Versuch (Retry-Flag seit dem 12:00-Befund standardmäßig gesetzt); `platform.claude.com` weiterhin nur per WebFetch auf `…/docs/en/release-notes/overview`. **Keine neuen Einträge**; der älteste Crawl-Block (23.08. 06:00) aus dem Header in die Git-Historie ausgelagert. — Ältere Crawl-Historie in den Git-Commits.)
