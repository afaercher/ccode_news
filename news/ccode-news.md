...
> Letzte Aktualisierung: 2026-07-30 06:00 UTC (Bestätigungs-Crawl 30.07.: **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.220** (25.07. 01:35), kein v2.1.221+; Platform-Release-Notes Top-Eintrag weiterhin **24.07.** (Claude Opus 5 auf API/Bedrock/Vertex/Foundry), dahinter 22.07. (Managed-Agents-Erweiterungen); Blog weiterhin **28.07.** („Bringing MCP to Claude"); What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, **Week 30 noch nicht veröffentlicht**. — Vorheriger Stand 2026-07-29 18:00 UTC (Bestätigungs-Crawl 29.07. (3. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.220** (25.07. 01:35), kein v2.1.221+; Platform-Release-Notes Top-Eintrag weiterhin **24.07.** (Claude Opus 5 auf API/Bedrock/Vertex/Foundry), dahinter 22.07. (Managed-Agents-Erweiterungen); Blog weiterhin **28.07.** („Bringing MCP to Claude"); What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, **Week 30 noch nicht veröffentlicht**. — Vorheriger Stand 2026-07-29 12:00 UTC (Bestätigungs-Crawl 29.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.220** (25.07. 01:35), kein v2.1.221+; Platform-Release-Notes Top-Eintrag weiterhin **24.07.** (Claude Opus 5 auf API/Bedrock/Vertex/Foundry), dahinter 22.07. (Managed-Agents-Erweiterungen); Blog weiterhin **28.07.** („Bringing MCP to Claude"); What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, **Week 30 noch nicht veröffentlicht**. Hinweis: die Platform-Release-Notes liegen jetzt unter `platform.claude.com/docs/en/release-notes/overview` — der frühere Pfad `/release-notes` liefert 404. — Vorheriger Stand 2026-07-29 06:00 UTC (Crawl 29.07.: **1 neuer Eintrag** — Blog-Post vom **28.07.** „Bringing MCP 2026-07-28 to Claude" nachgetragen: fünfte MCP-Spec-Version, u. a. Umstieg von einem bidirektionalen zustandsbehafteten Protokoll auf ein Request/Response-Modell (Serverless-/Edge-Deploy möglich), zwei standardisierte versionierte Extensions — **MCP Apps** (interaktive UI direkt im Chat) & **MCP Tasks** (langlaufende Arbeit ohne Core-Änderung) —, produktreife Authorization (Entra/Okta ohne Workarounds); Claude-Seite: >950 Connectors, Enterprise-Managed-Auth, Developer-Observability-Dashboards, **MCP-Tunnels** (Research Preview) für private Netzwerk-Server. Übrige drei Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.220** (25.07. 01:35), kein v2.1.221+; Platform-Release-Notes Top-Eintrag weiterhin **24.07.** (Claude Opus 5 auf API/Bedrock/Vertex/Foundry), dahinter 22.07. (Managed-Agents-Erweiterungen); What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, **Week 30 noch nicht veröffentlicht**. — Vorheriger Stand 2026-07-28 12:00 UTC (Bestätigungs-Crawl 28.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.220** (25.07. 01:35), kein v2.1.221+; Platform-Release-Notes Top-Eintrag weiterhin **24.07.** (Claude Opus 5 auf API/Bedrock/Vertex/Foundry), dahinter 22.07. (Managed-Agents-Erweiterungen); Blog weiterhin **23.07.** („Think through hard problems in voice mode"); What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, **Week 30 noch nicht veröffentlicht**. — Vorheriger Stand 2026-07-28 06:00 UTC (Bestätigungs-Crawl 28.07. (1. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.220** (25.07. 01:35), kein v2.1.221+; Platform-Release-Notes Top-Eintrag weiterhin **24.07.** (Claude Opus 5 auf API/Bedrock/Vertex/Foundry), dahinter 22.07. (Managed-Agents-Erweiterungen); Blog weiterhin **23.07.** („Think through hard problems in voice mode"); What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, **Week 30 noch nicht veröffentlicht**. — Vorheriger Stand 2026-07-27 18:00 UTC (Bestätigungs-Crawl 27.07. (3. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.220** (25.07. 01:35), kein v2.1.221+; Platform-Release-Notes Top-Eintrag weiterhin **24.07.** (Claude Opus 5 auf API/Bedrock/Vertex/Foundry), dahinter 22.07. (Managed-Agents-Erweiterungen); Blog weiterhin **23.07.** („Think through hard problems in voice mode"); What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, **Week 30 noch nicht veröffentlicht**. — Vorheriger Stand 2026-07-27 12:00 UTC (Bestätigungs-Crawl 27.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.220** (25.07. 01:35), kein v2.1.221+; Platform-Release-Notes Top-Eintrag weiterhin **24.07.** (Claude Opus 5 auf API/Bedrock/Vertex/Foundry), dahinter 22.07. (Managed-Agents-Erweiterungen); Blog weiterhin **23.07.** („Think through hard problems in voice mode"); What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, **Week 30 noch nicht veröffentlicht**. — Vorheriger Stand 2026-07-27 06:00 UTC (Bestätigungs-Crawl 27.07. (1. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.220** (25.07. 01:35), kein v2.1.221+; Platform-Release-Notes Top-Eintrag weiterhin **24.07.** (Claude Opus 5 auf API/Bedrock/Vertex/Foundry), dahinter 22.07. (Managed-Agents-Erweiterungen); Blog weiterhin **23.07.** („Think through hard problems in voice mode"); What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, **Week 30 noch nicht veröffentlicht**. — Vorheriger Stand 2026-07-26 18:00 UTC (Bestätigungs-Crawl 26.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.220** (25.07. 01:35), kein v2.1.221+; Platform-Release-Notes Top-Eintrag weiterhin **24.07.** (Claude Opus 5 auf API/Bedrock/Vertex/Foundry), dahinter 22.07. (Managed-Agents-Erweiterungen); Blog weiterhin **23.07.** („Think through hard problems in voice mode"); What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, **Week 30 noch nicht veröffentlicht**. — Vorheriger Stand 2026-07-26 12:00 UTC (Crawl 26.07.: **großer Nachtrag nach mehrtägiger Lücke** — **5 neue CLI-Versionen v2.1.216–v2.1.220** (20.–25.07.; Highlight: **Claude Opus 5** als neuer Opus-Default in v2.1.219, `/code-review` als Background-Subagent in v2.1.218, Subagent-Concurrency-Cap in v2.1.217, `sandbox.filesystem.disabled`/Perf-Fixes in v2.1.216, Reine Fixes in v2.1.220), **3 neue Platform-Blöcke** (17.07. Legacy-Workbench- & Prompt-Tools-Sunset zum 17.08.; 22.07. Managed-Agents-Erweiterungen — Effort, Lifecycle-Webhooks, Seed-Events, Thread-Deltas; **24.07. Claude Opus 5** auf API/Bedrock/Vertex/Foundry inkl. Thinking-Disable-Breaking-Change, Mid-Conversation-Tool-Changes-Beta, Fallbacks-`default`-Modus, Fast-Mode-Entfernung für Opus 4.7) und **1 neuer Blog-Post** (23.07. „Think through hard problems in voice mode"). What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, **Week 30 noch nicht veröffentlicht**. — Vorheriger Stand 2026-07-20 08:00 UTC (Bestätigungs-Crawl 20.07. (1. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.215** (19.07. 02:56), kein v2.1.216+; Platform-Release-Notes Top-Eintrag weiterhin **15.07.** (Mid-Conversation-System-Messages auf Fable 5/Mythos 5/Opus 4.8 ohne Beta-Header), dahinter 14.07. (Admin API); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, Week 30 noch nicht veröffentlicht. — Vorheriger Stand 2026-07-19 16:00 UTC (Bestätigungs-Crawl 19.07. (3. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.215** (19.07. 02:56), kein v2.1.216+; Platform-Release-Notes Top-Eintrag weiterhin **15.07.** (Mid-Conversation-System-Messages auf Fable 5/Mythos 5/Opus 4.8 ohne Beta-Header), dahinter 14.07. (Admin API); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, Week 30 noch nicht veröffentlicht. — Vorheriger Stand 2026-07-19 12:00 UTC (Bestätigungs-Crawl 19.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.215** (19.07. 02:56), kein v2.1.216+; Platform-Release-Notes Top-Eintrag weiterhin **15.07.** (Mid-Conversation-System-Messages auf Fable 5/Mythos 5/Opus 4.8 ohne Beta-Header), dahinter 14.07. (Admin API); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, Week 30 noch nicht veröffentlicht. — Vorheriger Stand 2026-07-19 08:00 UTC (Crawl 19.07.: **1 neue CLI-Version** — **v2.1.215** (19.07. 02:56) nachgetragen: Claude ruft die Skills `/verify` und `/code-review` nicht mehr von sich aus auf — sie sind jetzt ausschließlich manuell per `/verify` bzw. `/code-review` zu starten. Übrige drei Quellen unverändert gegengeprüft: Platform-Release-Notes Top-Eintrag weiterhin **15.07.** (Mid-Conversation-System-Messages auf Fable 5/Mythos 5/Opus 4.8 ohne Beta-Header), dahinter 14.07. (Admin API); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, Week 30 noch nicht veröffentlicht. — Vorheriger Stand 2026-07-18 16:00 UTC (Bestätigungs-Crawl 18.07. (3. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.214** (18.07. 01:20), kein v2.1.215+ (auch v2.1.213 bleibt übersprungen); Platform-Release-Notes Top-Eintrag weiterhin **15.07.** (Mid-Conversation-System-Messages auf Fable 5/Mythos 5/Opus 4.8 ohne Beta-Header), dahinter 14.07. (Admin API); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, Week 30 noch nicht veröffentlicht. — Vorheriger Stand 2026-07-18 12:00 UTC (Bestätigungs-Crawl 18.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.214** (18.07. 01:20), kein v2.1.215+ (auch v2.1.213 bleibt übersprungen); Platform-Release-Notes Top-Eintrag weiterhin **15.07.** (Mid-Conversation-System-Messages auf Fable 5/Mythos 5/Opus 4.8 ohne Beta-Header), dahinter 14.07. (Admin API); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 29** (13.–17.7., Tags v2.1.207–v2.1.212) als neuester Digest, Week 30 noch nicht veröffentlicht. — Vorheriger Stand 2026-07-18 08:00 UTC (Crawl 18.07.: **2 neue Einträge aus zwei Quellen** — (a) **1 neue CLI-Version**: **v2.1.214** (18.07. 01:20) nachgetragen: neues **EndConversation-Tool** (Umgang mit stark missbräuchlichen Nutzern/Jailbreak-Versuchen), periodischer Fortschritts-Heartbeat für lang laufende, still gewordene Tool-Calls, plus große Sicherheits-/Permission-Härtung (single-segment `dir/**`-Allow-Regeln genehmigten fälschlich verschachtelte Writes überall im Baum statt nur `<cwd>/dir`; Permission-Check-Bypass unter Windows PowerShell 5.1; Bash-Checks bei File-Descriptor-Redirects, zsh-Subscripts, Befehlen >10.000 Zeichen sowie `help`/`man` mit unsicheren Optionen; `docker`-Daemon-Redirect-Flags und `file -m/-f` verlangen jetzt Freigabe; Settings-Dateien >2 MiB scheitern beim Start) sowie viele Windows/PowerShell-, Background-Session- und OTel-Fixes. Hinweis: **v2.1.213 wurde übersprungen** (kein GitHub-Tag, nicht im CHANGELOG; Versionsfolge geht direkt v2.1.212 → v2.1.214). (b) **What's-New Week 29 (13.–17.7., Tags v2.1.207–v2.1.212) ist jetzt veröffentlicht** — daraus ein bislang undokumentiertes Feature nachgetragen: **Artifacts rufen MCP-Connectors auf** (veröffentlichte Artifacts ziehen bei jedem Aufruf Live-Daten über die MCP-Connectors des jeweiligen Betrachters, plus öffentliche Share-Links, Editor-Rollen auf Team/Enterprise, Artifacts aus Claude-Tag-Sessions). Übrige Digest-Highlights (Screen-Reader-Modus, `/fork`, Auto-Mode ohne Opt-in, MCP-Auto-Backgrounding, `claude auto-mode reset`, Session-Caps, Corporate-Launcher, `--forward-subagent-text` u. a.) bereits über CLI-Einträge dokumentiert. Übrige zwei Quellen unverändert gegengeprüft: Platform-Release-Notes Top-Eintrag weiterhin **15.07.** (Mid-Conversation-System-Messages auf Fable 5/Mythos 5/Opus 4.8 ohne Beta-Header); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web). — Vorheriger Stand 2026-07-17 16:00 UTC (Bestätigungs-Crawl 17.07. (3. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.212** (17.07. 00:26), kein v2.1.213+; Platform-Release-Notes Top-Eintrag weiterhin **15.07.** (Mid-Conversation-System-Messages auf Fable 5/Mythos 5/Opus 4.8 ohne Beta-Header), dahinter 14.07. (Admin API); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Stand 2026-07-17 12:00 UTC (Bestätigungs-Crawl 17.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.212** (17.07. 00:26), kein v2.1.213+; Platform-Release-Notes Top-Eintrag weiterhin **15.07.** (Mid-Conversation-System-Messages auf Fable 5/Mythos 5/Opus 4.8 ohne Beta-Header), dahinter 14.07. (Admin API); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Stand 2026-07-17 08:00 UTC (Crawl 17.07.: **1 neue CLI-Version** — **v2.1.212** (17.07. 00:26) nachgetragen: neue Session-Management-Befehle (`/fork` kopiert Konversationen in neue Background-Sessions bei laufender Arbeit, `/subtask` ersetzt das In-Session-Subagent-Starten, `/resume`-Picker zeigt jetzt auch gelöschte Sessions, `claude auto-mode reset` mit Bestätigung), neue Ressourcen-Limits gegen Runaway-Automatik (Session-weites WebSearch-Limit `CLAUDE_CODE_MAX_WEB_SEARCHES_PER_SESSION` Default 200, Subagent-Spawn-Cap `CLAUDE_CODE_MAX_SUBAGENTS_PER_SESSION` Default 200), Auto-Backgrounding langer MCP-Calls (>2 min, `CLAUDE_CODE_MCP_AUTO_BACKGROUND_MS`), plus große Bugfix-Sammlung (Plan-Mode führte dateiändernde Bash-Befehle ohne Freigabe aus, `/ultrareview` lehnte PR-Referenzen ab und holte keine Remote-Branches, SIGTERM verwaiste Bash-Prozessbäume im Print/SDK-Modus, Datei-Edit-„not read yet"-Fehler nach Resume, Konversationen mit vielen Bildern scheiterten mit „Request too large", `forceLoginMethod` jetzt auch für VS Code/SDK erzwungen u. v. m.). Übrige drei Quellen unverändert gegengeprüft: Platform-Release-Notes Top-Eintrag weiterhin **15.07.** (Mid-Conversation-System-Messages auf Fable 5/Mythos 5/Opus 4.8 ohne Beta-Header); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Stand 2026-07-16 22:00 UTC (Crawl 16.07. (3. Lauf): **1 neuer Platform-Eintrag** — Platform-Release-Notes-Eintrag vom **15.07.** nachgetragen: **Mid-Conversation-System-Messages** sind jetzt auf Claude Fable 5, Claude Mythos 5 und Claude Opus 4.8 verfügbar (Claude API, Amazon Bedrock, Google Cloud/Vertex AI), **ohne Beta-Header** — korrigiert frühere Verfügbarkeitshinweise. Damit rückt der Platform-Release-Notes-Top-Eintrag von 14.07. auf **15.07.** vor. Übrige drei Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.211** (15.07. 23:02), kein v2.1.212+; Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Stand 2026-07-16 18:00 UTC (Bestätigungs-Crawl 16.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.211** (15.07. 23:02), kein v2.1.212+; Platform-Release-Notes Top-Eintrag weiterhin **14.07.** (Admin API für Claude-Enterprise-User-Management), dahinter 10.07. (Dreams mit Fable 5/Sonnet 5 + Access-Transparency-`cmek_preserve`-Doku); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Stand 2026-07-16 12:00 UTC (Crawl 16.07.: **1 neue CLI-Version** — **v2.1.211** (15.07. 23:02) nachgetragen: neues Flag/Env `--forward-subagent-text`, um Subagent-Text in die `stream-json`-Ausgabe durchzureichen, plus Bugfix-Sammlung (Auto-Mode überschrieb `ask`-Entscheidungen von PreToolUse-Hooks; Permission-Preview neutralisiert jetzt Steuerzeichen für Chat-Channels; Logout-Probleme bei parallelen Sessions nach Wake-from-Sleep; Plugin-MCP-Server-Reconnect nach inaktiven Web-Sessions; Modell-Override kippte in resumten Subagents zurück; mehrere File-Upload-/UI-Fixes). Übrige drei Quellen unverändert gegengeprüft: Platform-Release-Notes Top-Eintrag weiterhin **14.07.** (Admin API für Claude-Enterprise-User-Management), dahinter 10.07.; Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Stand 2026-07-15 18:00 UTC (Bestätigungs-Crawl 15.07. (3. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.210** (14.07. 23:45), kein v2.1.211+; Platform-Release-Notes Top-Eintrag weiterhin **14.07.** (Admin API für Claude-Enterprise-User-Management), dahinter 10.07. (Dreams mit Fable 5/Sonnet 5 + Access-Transparency-`cmek_preserve`-Doku); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Bestätigungs-Crawl 15.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.210** (14.07. 23:45), kein v2.1.211+; Platform-Release-Notes Top-Eintrag weiterhin **14.07.** (Admin API für Claude-Enterprise-User-Management), dahinter 10.07. (Dreams mit Fable 5/Sonnet 5 + Access-Transparency-`cmek_preserve`-Doku); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Crawl 15.07. (1. Lauf): **2 neue Einträge aus zwei Quellen** — (a) **1 neue CLI-Version**: **v2.1.210** (14.07. 23:45) nachgetragen: Live-Countdown der verstrichenen Zeit in der eingeklappten Tool-Zusammenfassung bei lang laufenden Tool-Calls, Startup-Warnung für `Write(path)`/`NotebookEdit(path)`/`Glob(path)`-Permission-Regeln (stattdessen `Edit(path)`/`Read(path)`), Auto-Mode-Permission-Classifier defaultet auf Sonnet 5, Agent-Tool gegen indirekte Prompt-Injection gehärtet, Memory-Writes über Limit werfen einen expliziten Fehler statt still zu kürzen, plus große Bugfix-Sammlung (`isolation:'worktree'`-Subagents führten git-mutierende Befehle gegen das Haupt-Checkout aus, `ultracode`-Opt-in feuerte bei nicht-menschlichem Input wie Webhook-Payloads/weitergeleiteten PR-Kommentaren, `claude attach`-Session-Übergangsfehler, Crash bei bigint/Plain-Text-Tool-Result-Renderer, Hook-Callback-Timeout als User-Ablehnung fehlgemeldet, Plugin-MCP-Server bei Re-Sync abgebaut, Grep-Pagination, verschluckte `$1`/`$2`-Platzhalter, Background-Worker-Crash-Loop bei Connection-Reset, getötete Background-Sessions hinterließen dauerhaften `git worktree lock` u. v. m.). (b) **1 neuer Platform-Punkt** vom **14.07.**: **Admin API für Claude-Enterprise-User-Management** (Beta für alle Claude-Enterprise-Orgs) — Mitglieder auflisten/per E-Mail suchen, Rollen ändern, entfernen, Einladungen senden/zurückziehen, Gruppen & Mitgliedschaften verwalten, Custom Roles lesen; Gruppen-/Custom-Role-Requests brauchen den Beta-Header `ce-user-management-2026-07-13`. Damit rückt der Platform-Release-Notes-Top-Eintrag von 10.07. auf **14.07.** vor. Übrige zwei Quellen unverändert gegengeprüft: What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht; Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web). — Vorheriger Stand 2026-07-14 (Bestätigungs-Crawl 14.07. (3. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.209** (14.07. 06:36), kein v2.1.210+; Platform-Release-Notes Top-Eintrag weiterhin **10.07.** (Dreams mit Fable 5/Sonnet 5 + Access-Transparency-`cmek_preserve`-Doku), dahinter 08.07. (API-Key-Ablaufdatum); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. Hinweis: `platform.claude.com/docs/en/release-notes` liefert derzeit 404 — die Release-Notes liegen unter `platform.claude.com/docs/en/release-notes/api`. — Vorheriger Crawl 14.07. (2. Lauf): **1 neuer Eintrag** — **v2.1.209** (14.07. 06:36) nachgetragen: Ein-Zeilen-Patch, der `/model` und andere Dialoge in `claude agents`-Background-Sessions wieder freigibt (zu breit gefasster Guard aus 2.1.208 zurückgenommen). Übrige drei Quellen unverändert gegengeprüft: Platform-Release-Notes Top-Eintrag weiterhin **10.07.** (Dreams mit Fable 5/Sonnet 5 + Access-Transparency-`cmek_preserve`-Doku); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Crawl 14.07. (1. Lauf): **2 neue Einträge aus zwei Quellen** — (a) **1 neue CLI-Version**: **v2.1.208** (14.07. 01:10) nachgetragen: Screenreader-Modus (`--ax-screen-reader` / `CLAUDE_AX_SCREEN_READER` / `axScreenReader`), `vimInsertModeRemaps` (z. B. `jj` → Escape), `CLAUDE_CODE_PROCESS_WRAPPER` für Corporate-Launcher, Maus-Klicks in Multi-Select-Menüs, große Performance-Runde (bis zu 7× schnellere Tool-Runden bei vielen MCP-Tools, Edit-Cache auf 16 MB gedeckelt, Transkripte bis 79× kleiner, kompilierte Permission-Regel-Matcher, mehrere Memory-Leaks), plus sehr große Bugfix-Sammlung (Fast-Mode kehrt zurück, verlorene Background-Agent-Antworten, „Couldn't start the background daemon" nach Update, falsches 200k-Kontextfenster nach Auto-Update, HTTP/2-GOAWAY-Crash, abgeschnittene `stream-json`-Ausgabe, `1e6`→`1`-Env-Var-Bug, Edit/Read/Grep/Glob-Fixes, `/release-notes` injizierte das Changelog in den Kontext, Bedrock-SSO-Regression aus 2.1.207 u. v. m.). (b) **1 neuer Platform-Punkt** unter dem 10.07.-Eintrag: **Dreams (Research Preview) unterstützt jetzt Claude Fable 5 und Claude Sonnet 5** (bislang war von diesem Datum nur die Access-Transparency-`cmek_preserve`-Doku erfasst). Übrige zwei Quellen unverändert gegengeprüft: Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Stand 2026-07-13 (Bestätigungs-Crawl 13.07. (3. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.207** (11.07.), kein v2.1.208+ (Release-Atom-Feed bestätigt); Platform-Release-Notes Top-Eintrag weiterhin **10.07.** (Access-Transparency-`cmek_preserve`-Doku), dahinter 08.07. (API-Key-Ablaufdatum); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Bestätigungs-Crawl 13.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.207** (11.07.), kein v2.1.208+ (Release-Atom-Feed bestätigt); Platform-Release-Notes Top-Eintrag weiterhin **10.07.** (Access-Transparency-`cmek_preserve`-Doku), dahinter 08.07. (API-Key-Ablaufdatum); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Bestätigungs-Crawl 13.07. (1. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.207** (11.07.), kein v2.1.208+ (Release-Atom-Feed bestätigt); Platform-Release-Notes Top-Eintrag weiterhin **10.07.** (Access-Transparency-`cmek_preserve`-Doku), dahinter 08.07. (API-Key-Ablaufdatum); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Stand 2026-07-12 (Bestätigungs-Crawl 12.07. (3. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.207** (11.07.), kein v2.1.208+ (Release-Atom-Feed bestätigt); Platform-Release-Notes Top-Eintrag weiterhin **10.07.** (Access-Transparency-`cmek_preserve`-Doku), dahinter 08.07. (API-Key-Ablaufdatum); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Bestätigungs-Crawl 12.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.207** (11.07.), kein v2.1.208+ (Release-Atom-Feed bestätigt); Platform-Release-Notes Top-Eintrag weiterhin **10.07.** (Access-Transparency-`cmek_preserve`-Doku), dahinter 08.07. (API-Key-Ablaufdatum); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Bestätigungs-Crawl 12.07. (1. Lauf): **keine neuen Einträge** — alle vier Quellen gegengeprüft: neueste CLI weiterhin **v2.1.207** (11.07. 00:52 UTC), kein v2.1.208+ (auch im Release-Atom-Feed bestätigt); Platform-Release-Notes Top-Eintrag weiterhin **10.07.** (Access-Transparency-`cmek_preserve`-Doku), dahinter 08.07. (API-Key-Ablaufdatum); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Stand 2026-07-11 (Bestätigungs-Crawl 11.07. (3. Lauf): **keine neuen Einträge** — alle vier Quellen erneut gegengeprüft: neueste CLI weiterhin **v2.1.207** (11.07. 00:52 UTC), kein v2.1.208+; Platform-Release-Notes Top-Eintrag weiterhin **10.07.** (Access-Transparency-`cmek_preserve`-Doku), dahinter 08.07. (API-Key-Ablaufdatum); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Bestätigungs-Crawl 11.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.207** (11.07. 00:52 UTC), kein v2.1.208+; Platform-Release-Notes Top-Eintrag weiterhin **10.07.** (Access-Transparency-`cmek_preserve`-Doku), dahinter 08.07. (API-Key-Ablaufdatum); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 28** (6.–10.7., Tags v2.1.202–v2.1.206) als neuester Digest, Week 29 noch nicht veröffentlicht. — Vorheriger Crawl 11.07. (1. Lauf): **4 neue Einträge aus zwei Quellen** — (a) **1 neue CLI-Version**: **v2.1.207** (11.07. 00:52 UTC) nachgetragen: Auto-Mode ohne `CLAUDE_CODE_ENABLE_AUTO_MODE`-Opt-in auf Bedrock/Vertex/Foundry (abschaltbar via `disableAutoMode`), Bedrock/Vertex/Claude-Platform-on-AWS defaulten auf Claude Opus 4.8, `autoMode` und `pluginConfigs` werden nicht mehr aus repo-lokalen Settings gelesen, Shell-Injection-Fix (`${user_config.*}` in Shell-Form-Plugin-Hooks abgelehnt), Terminal-Freeze bei langen Streaming-Antworten behoben, plus große Bugfix-Sammlung (Consent-Dialog bei Remote Managed Settings im `-p`/SDK-Lauf, Auto-Updater überschrieb eigenen Launcher, Crash-Schleife in Agent-Teams, Bedrock-SSO-Credential-Sturm, Windows-Hang bei stockender AWS-Credential-Auflösung, `/usage-credits`-Betragsvalidierung u. v. m.). (b) **What's-New-Digests Woche 27 und 28 sind jetzt veröffentlicht** (vorher endete die Digest-Liste bei Week 26): daraus drei bislang undokumentierte Features nachgetragen — **eingebauter Browser in der Desktop-App** (sandboxed, Safety-Classifier, optionale Persistenz der Browsing-Session), **Claude Desktop für Linux** (Beta auf Ubuntu 22.04+/Debian 12+, x86_64+arm64, via apt-Repo) und **`/radio`** (Claude-FM-Lo-Fi-Stream). Übrige Digest-Inhalte (Sonnet 5, Claude in Chrome GA, Background-Subagents, Artifacts GA, Org-Default-Modell u. a.) waren bereits über die CLI-Release-Einträge dokumentiert. Übrige zwei Quellen unverändert gegengeprüft: Platform-Release-Notes Top-Eintrag weiterhin **10.07.** (Access-Transparency-`cmek_preserve`-Doku), dahinter 08.07. (API-Key-Ablaufdatum); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web). — Vorheriger Stand 2026-07-10 (Crawl 10.07. (3. Lauf): **1 neuer Eintrag** — Platform-Release-Notes-Eintrag vom **10.07.** nachgetragen: Die Access-Transparency-`cmek_preserve`-Dokumentation wurde erweitert (Filter-Beispiel, Beispiel-Event-Payload, zwei Aufbewahrungsgründe `policy_violation_investigation`/`csae_report`; Klarstellung, dass ein Preservation-Event bei menschlicher wie automatisierter Auslösung geschrieben wird). Damit rückt der Platform-Release-Notes-Top-Eintrag von 08.07. auf **10.07.** vor. Übrige drei Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.206** (10.07. 01:45 UTC), kein v2.1.207+; Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 26** (22.–26.6.), Week 27/28 noch nicht als Digest veröffentlicht. — Vorheriger Bestätigungs-Crawl 10.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.206** (10.07. 01:45 UTC), kein v2.1.207+; Platform-Release-Notes Top-Eintrag **08.07.** (API-Key-Ablaufdatum in der Console), dahinter 02.07. (managed-agents Memory-Beta-Header); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 26** (22.–26.6.), Week 27/28 noch nicht als Digest veröffentlicht. — Vorheriger Stand 2026-07-10 (Crawl 10.07.: **1 neue CLI-Version** — **v2.1.206** (10.07. 01:45 UTC) nachgetragen: Verzeichnis-Vorschläge für `/cd`, `/doctor`-Check zum Verschlanken eingecheckter `CLAUDE.md`-Dateien, `/commit-push-pr` erlaubt `git push` auch ans konfigurierte Push-Remote (nicht nur `origin`), `/login` unterstützt öffentliche Anthropic-Gateway-Endpunkte, `EnterWorktree` fragt bei Worktrees außerhalb `.claude/worktrees/` nach, Background-Agents upgraden sich nach Update im Hintergrund, `/code-review`-Qualität auf claude-opus-4-8 verbessert, Agent-View mit voller Terminalbreite + `Ctrl+X`-Löschung, plus große Bugfix-Sammlung (irreführender Modellfehler bei abgelaufenem Login → `/login`, ignoriertes `request_timeout_ms`, verschlucktes `CLAUDE_CODE_EXTRA_BODY` in Background-Workern, OAuth-MCP-Reauth, falsche `/model`-Preise, Bedrock-`awsCredentialExport`-Startup-Hang u. v. m.). Übrige drei Quellen unverändert gegengeprüft: Platform-Release-Notes Top-Eintrag weiterhin **08.07.** (API-Key-Ablaufdatum in der Console), dahinter 02.07. (managed-agents Memory-Beta-Header); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 26** (22.–26.6.), Week 27/28 noch nicht als Digest veröffentlicht. — Vorheriger Stand 2026-07-09 (Crawl 09.07. (3. Lauf): **1 neuer Eintrag** — Platform-Release-Notes-Eintrag vom **08.07.** nachgetragen: In der Claude Console lässt sich beim Erstellen eines API-/Admin-API-Keys jetzt ein **Ablaufdatum** setzen (Preset/benutzerdefiniert/„Never"); für Keys ≥ 7 Tage Laufzeit E-Mail-Warnung vor Ablauf, Admin-API meldet `expires_at`, bestehende Keys unverändert. Damit rückt der Platform-Release-Notes-Top-Eintrag von 01.07. auf **08.07.** vor. Übrige drei Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.205** (08.07. 21:22), kein v2.1.206+; Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web); What's-New weiterhin **Week 26** (22.–26.6.), Week 27/28 noch nicht als Digest veröffentlicht. — Vorheriger Bestätigungs-Crawl 09.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.205** (08.07. 21:22), kein v2.1.206+; Platform-Release-Notes Top-Eintrag weiterhin **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web) als neueste Posts; What's-New weiterhin **Week 26** (22.–26.6.), Week 27/28 noch nicht als Digest veröffentlicht. — Vorheriger Stand 2026-07-09 (Crawl 09.07.: **1 neue CLI-Version** — **v2.1.205** (08.07. 21:22) nachgetragen: neue Auto-Mode-Regel gegen Manipulation von Session-Transkript-Dateien, `/doctor` ist jetzt ein vollständiger Setup-Checkup (Alias `/checkup`), Auto-Update-Downloads streamen auf Platte statt in den RAM (~400 MB weniger Peak-Speicher), Background-Task-Notifications weisen explizit auf fehlende menschliche Eingabe hin (gegen fabrizierte In-Transcript-Freigaben), Agent-View mit farbigem Status-Wort + Classifier-Headline und PR-Verlinkung bei Edit/Merge/Comment/Push, `--json-schema`-Fixes (ungültiges Schema/`format`-Keyword), reservierter MCP-Name „Claude Browser", plus große Bugfix-Sammlung (Windows-Worktree-Löschung via NTFS-Junction, `--max-turns`-Nachrichtenverlust, Cowork-VM-Login-Fix auf 2.1.203+ u. v. m.). Übrige drei Quellen unverändert gegengeprüft: Platform-Release-Notes Top-Eintrag weiterhin **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web) als neueste Posts; What's-New weiterhin **Week 26** (22.–26.6.), Week 27/28 noch nicht als Digest veröffentlicht. — Vorheriger Stand 2026-07-08 (Bestätigungs-Crawl 08.07. (3. Lauf): **keine neuen Einträge** — alle vier Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.204** (08.07. 00:27), kein v2.1.205+; Platform-Release-Notes Top-Eintrag weiterhin **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web) als neueste Posts; What's-New weiterhin **Week 26** (22.–26.6.), Week 27/28 noch nicht als Digest veröffentlicht. — Vorheriger Bestätigungs-Crawl 08.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.204** (08.07. 00:27), kein v2.1.205+; Platform-Release-Notes Top-Eintrag weiterhin **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web) als neueste Posts; What's-New weiterhin **Week 26** (22.–26.6.), Week 27/28 noch nicht als Digest veröffentlicht. — Vorheriger Stand 2026-07-08 (Crawl 08.07.: **2 neue CLI-Versionen** — **v2.1.204** (08.07.) nachgetragen: SessionStart-Hooks streamen im Headless-Modus wieder (kein Idle-Reaping von Remote-Workern mitten im Hook mehr). **v2.1.203** (07.07.) nachgetragen: Warnung vor ablaufendem Login, grauer ⏸-Badge im Footer bei manuellem Berechtigungsmodus, zusätzliche Arbeitsverzeichnisse in MCP `roots/list` (+`list_changed`-Notification), VS-Code-Toggle „Enable Remote Control for all sessions", plus große Bugfix-Sammlung mit Fokus Background-Sessions & Git-Worktrees (macOS-15–20-s-Stall behoben, veraltetes Daemon-Session-Token erholt sich, laufende Subagents gehen bei Rückkehr zu `claude agents` nicht mehr verloren, verschluckte `PATH`/`ANTHROPIC_BASE_URL`, Binär-/Startup-Speicher je ~7 MB kleiner). Übrige zwei Quellen unverändert gegengeprüft: Platform-Release-Notes Top-Eintrag weiterhin **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); What's-New weiterhin **Week 26** (22.–26.6.), Week 27/28 noch nicht als Digest veröffentlicht; Blog weiterhin **07.07.** (Government-Beta & Cowork Mobile/Web) als neueste Posts. — Vorheriger Stand 2026-07-07 (Crawl 07.07. (3. Lauf): **2 neue Blog-Einträge** — zwei Announcement-Posts vom **07.07.** nachgetragen: „Bringing Claude Code and Claude Cowork to government" (Claude Code & Claude Cowork in Public Beta über **Claude for Government Desktop**, FedRAMP-High-Umgebung, ATO-Unterstützung mit Hash-Chain-Audit-Logs, SCIM-Group-Mappings, lokal gespeicherter Verlauf) und „Claude Cowork is coming to mobile and web" (Cowork-Beta für Max auf iOS/Android/Web, Cross-Device-Continuity, Hintergrund-Ausführung ohne aktives Gerät, Entscheidungs-Handoff per Handy-Notification, Cowork-Limits bis 05.08. verdoppelt). Übrige drei Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.202** (06.07. 22:51), kein v2.1.203+; Platform-Release-Notes Top-Eintrag weiterhin **01.07.** (Fable 5 & Mythos 5), dahinter 30.6. (Sonnet 5); What's-New weiterhin **Week 26** (22.–26.6.), Week 27/28 noch nicht als Digest veröffentlicht. — Vorheriger Bestätigungs-Crawl 07.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.202** (06.07. 22:51), kein v2.1.203+; Platform-Release-Notes Top-Eintrag weiterhin **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog weiterhin **02.07.** (Admin-Analytics & Kostenkontrolle); What's-New weiterhin **Week 26** (22.–26.6.), Week 27/28 noch nicht als Digest veröffentlicht. — Vorheriger Crawl 07.07. (1. Lauf): **1 neue CLI-Version** — **v2.1.202** (06.07. 22:51) nachgetragen: „Dynamic workflow size"-Einstellung in `/config`, OpenTelemetry-Attribute `workflow.run_id`/`workflow.name` für Workflow-Agents, `/review <pr>` wieder als schneller Single-Pass (Multi-Agent jetzt via `/code-review <level> <pr#>`), Skill-Doppel-Laden behoben plus große Bugfix-Sammlung (Ctrl+R-History-Crash, `/rename` auf Background-Sessions, mTLS-Rotation, Remote-Control-Befehle/Bilder, SSH-Sign-in-Link, `claude agents`-Chat-Crash-Loop, Workflow-Unicode-Escapes, Sprachdiktat-Endlosschleife, Resume-Speed in Worktree-Repos, Download-Retry). Übrige drei Quellen unverändert gegengeprüft: Platform-Release-Notes Top-Eintrag weiterhin **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog weiterhin **02.07.** (Admin-Analytics & Kostenkontrolle); What's-New weiterhin **Week 26** (22.–26.6.), Week 27/28 noch nicht als Digest veröffentlicht. — Vorheriger Stand 2026-07-06 (Bestätigungs-Crawl 06.07. (3. Lauf): **keine neuen Einträge** — alle vier Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.201** (03.07. 23:50), kein v2.1.202+; Platform-Release-Notes Top-Eintrag weiterhin **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog weiterhin **02.07.** (Admin-Analytics & Kostenkontrolle); What's-New weiterhin **Week 26** (22.–26.6.), Week 27 noch nicht als Digest veröffentlicht. — Vorheriger Bestätigungs-Crawl 06.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.201** (03.07. 23:50), kein v2.1.202+; Platform-Release-Notes Top-Eintrag weiterhin **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog weiterhin **02.07.** (Admin-Analytics & Kostenkontrolle); What's-New weiterhin **Week 26** (22.–26.6.), Week 27 noch nicht als Digest veröffentlicht. — Vorheriger Bestätigungs-Crawl 06.07. (1. Lauf): **keine neuen Einträge** — alle vier Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.201** (03.07. 23:50), kein v2.1.202+; Platform-Release-Notes Top-Eintrag weiterhin **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog weiterhin **02.07.** (Admin-Analytics & Kostenkontrolle); What's-New weiterhin **Week 26** (22.–26.6.), Week 27 noch nicht als Digest veröffentlicht. — Vorheriger Stand 2026-07-05 (Bestätigungs-Crawl 05.07. (3. Lauf): **keine neuen Einträge** — alle vier Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.201** (03.07. 23:50), kein v2.1.202+; Platform-Release-Notes Top-Eintrag weiterhin **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog weiterhin **02.07.** (Admin-Analytics & Kostenkontrolle); What's-New weiterhin **Week 26** (22.–26.6.), Week 27 noch nicht als Digest veröffentlicht. — Vorheriger Bestätigungs-Crawl 05.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.201** (03.07. 23:50), kein v2.1.202+; Platform-Release-Notes Top-Eintrag weiterhin **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog weiterhin **02.07.** (Admin-Analytics & Kostenkontrolle); What's-New weiterhin **Week 26** (22.–26.6.), Week 27 noch nicht als Digest veröffentlicht. — Vorheriger Bestätigungs-Crawl 05.07. (1. Lauf): **keine neuen Einträge** — alle vier Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.201** (03.07. 23:50), kein v2.1.202+; Platform-Release-Notes Top-Eintrag weiterhin **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog weiterhin **02.07.** (Admin-Analytics & Kostenkontrolle); What's-New weiterhin **Week 26** (22.–26.6.), Week 27 noch nicht als Digest veröffentlicht. — Vorheriger Stand 2026-07-04 (Bestätigungs-Crawl 04.07. (3. Lauf): **keine neuen Einträge** — alle vier Quellen unverändert gegengeprüft: neueste CLI weiterhin **v2.1.201** (03.07. 23:50), kein v2.1.202+; Platform-Release-Notes Top-Eintrag weiterhin **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog weiterhin **02.07.** (Admin-Analytics & Kostenkontrolle); What's-New weiterhin **Week 26** (22.–26.6.), Week 27 noch nicht als Digest veröffentlicht. — Vorheriger Crawl 04.07. (1. Lauf): **1 neue CLI-Version** — **v2.1.201** (03.07. 23:50) nachgetragen: In Claude-Sonnet-5-Sessions werden Harness-Reminder nicht mehr über eine Mid-Conversation-`system`-Rolle übermittelt. Übrige drei Quellen unverändert gegengeprüft: Platform-Release-Notes weiterhin Top-Eintrag **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog weiterhin **02.07.** (Admin-Analytics & Kostenkontrolle); What's-New weiterhin **Week 26** (22.–26.6.), Week 27 noch nicht als Digest veröffentlicht. — Vorheriger Stand 2026-07-03 (Crawl 03.07. (3. Lauf): **1 neue CLI-Version** — **v2.1.200** (03.07. 16:52) nachgetragen: `AskUserQuestion`-Dialoge laufen nicht mehr automatisch weiter (Idle-Timeout jetzt Opt-in via `/config`), Standard-Berechtigungsmodus über CLI/VS Code/JetBrains auf „Manual" umgestellt, plus große Bugfix-/Stabilitäts-Sammlung (Background-Sessions nach Sleep/Wake & Stall-Respawn, Daemon-Handover nach Versions-Zeitstempel, `.claude.json`-Non-Array-Startup-Crash, Screenreader-Verbesserungen, OOM-Hinweis im Install-Skript). Übrige drei Quellen unverändert: Platform-Release-Notes weiterhin Top-Eintrag **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog weiterhin **02.07.** (Admin-Analytics & Kostenkontrolle); What's-New weiterhin **Week 26** (22.–26.6.), Week 27 noch nicht als Digest veröffentlicht. — Vorheriger Bestätigungs-Crawl 03.07. (2. Lauf): **keine neuen Einträge** — alle vier Quellen unverändert gegengeprüft: **v2.1.199** (02.07.) neueste CLI; Platform-Release-Notes Top-Eintrag **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog **02.07.** (Admin-Analytics & Kostenkontrolle); What's-New **Week 26** (22.–26.6.) als letzter Digest, Week 27 noch nicht veröffentlicht. — Vorheriger Crawl 03.07. (1. Lauf): **v2.1.199** (02.07. 23:35) nachgetragen — neue neueste CLI-Version mit u. a. gestapelten Slash-Skill-Aufrufen (bis zu 5 Skills), sofortigem SSL-Fehler-Hinweis, Auto-Retry transienter 429er mit Backoff, `CLAUDE_CODE_RETRY_WATCHDOG` (300 Retries, Cap-Aufhebung für `CLAUDE_CODE_MAX_RETRIES`), erhaltenen Teil-Streaming-Antworten, korrekter Subagent-Fehlerweitergabe an den Parent, `#N`-PR-Links in `claude agents` sowie großer Bugfix-Sammlung (Background-Agent-Daemon-Selbstabschuss, SSH-/macOS-Coldstart, `claude stop`-Race, Config-Recovery-Backup u. v. m.). Übrige Quellen unverändert: Platform-Release-Notes weiterhin Top-Eintrag **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6. (Sonnet 5); Blog weiterhin **02.07.** (Admin-Analytics & Kostenkontrolle); What's-New weiterhin **Week 26** (22.–26.6.), Week 27 noch nicht als Digest veröffentlicht. Alle vier Quellen gegengeprüft. — Vorheriger Stand 2026-07-02 17:30 UTC (Crawl 02.07. abends: **1 neuer Eintrag** — Blog-Post vom **02.07.** „Giving admins more visibility and control over Claude spend" nachgetragen (Admin-Analytics & Kostenkontrolle: Team-/User-Dashboards, Claude-Code-Analytics, Value-Tab/ROI, Analytics-Chat & -API, Spend-Alerts 75/90 %, Per-Group-Caps, Model-Defaults/Entitlements, Admin-API). CLI weiterhin **v2.1.198** (01.07., kein v2.1.199+); Platform-Release-Notes weiterhin Top-Eintrag **01.07.** (Fable 5 & Mythos 5 wiederhergestellt), dahinter 30.6.; What's-New weiterhin **Week 26** (22.–26.6.) als letzter Digest, Week 27 noch nicht veröffentlicht; alle vier Quellen gegengeprüft. — Vorheriger Crawl 02.07. (Bestätigung): keine neuen Einträge. — Crawl 02.07. früh: **v2.1.198 (01.07.) nachgetragen** — neue neueste CLI-Version mit u. a. Claude in Chrome GA, Background-Agent-Notifications-Hooks (`agent_needs_input`/`agent_completed`), `/dataviz`-Skill, Gateway-Upstream „Claude Platform on AWS" (`anthropicAws`), Auto-Commit/Push/Draft-PR bei Background-Agent-Abschluss, Explore-Agent erbt Session-Modell (max. Opus), Subagents erben Extended-Thinking-Config, `/agents`-Wizard entfernt, highlight.js 11 sowie große Bugfix-Sammlung. **Platform-Release-Notes 01.07. nachgetragen**: Zugriff auf Claude Fable 5 & Mythos 5 wiederhergestellt. Blog weiterhin **29.6.** (Bedrock/Google-Cloud-Gateway, Microsoft Foundry GA) als neuester Post. What's-New weiterhin **Week 26 (22.–26.6.)** als letzter Digest (Week 27 noch nicht veröffentlicht). Alle vier Quellen gegengeprüft. Hinweis: Platform-Release-Notes liegen unter platform.claude.com/docs/en/release-notes/api.)
