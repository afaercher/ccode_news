...
> Letzte Aktualisierung: 2026-09-04 18:00 UTC (**Crawl 04.09. 18:00 UTC — der Freitags-Release ist da, aber erst halb: v2.1.261 wurde um 17:49 UTC auf npm publiziert**, elf Minuten vor diesem Lauf. Der Rollout ist im Zwischenzustand sichtbar: Tag `next` steht bereits auf **2.1.261**, `latest` hängt noch auf 2.1.260, `stable` unverändert 2.1.236; `time.modified` 04.09. **17:49:35 UTC**. **Kein GitHub-Tag und kein Release zu v2.1.261** (`git/ref/tags/v2.1.261` und `releases/tags/v2.1.261` beide HTTP 404), die Releases-API endet unverändert bei v2.1.260 (03.09. 23:48 UTC); `CHANGELOG.md` byte-identisch zum 12:00-Abruf, Top weiter 2.1.260 -> 2.1.259 -> 2.1.258 -> 2.1.257 -> 2.1.252. **Was v2.1.261 enthält, ist damit noch nirgends veröffentlicht** — der Abstand npm -> GitHub-Release lag zuletzt bei rund einer Stunde (v2.1.260: 22:32 -> 23:48), der Inhalt sollte beim Lauf am 05.09. 06:00 vollständig vorliegen und wird dann nachgetragen. Rhythmus bestätigt: die Werktags-Serie seit 17.08. hält, diese Woche **Montag bis Freitag lückenlos** (v2.1.252, 257/258, 259, 260, 261); der Freitags-Publish um 17:49 UTC liegt im Muster der beiden Vorfreitage (21.08. 17:18, 28.08. 15:34), und die Prognose des 12:00-Laufs (Freitags-Release frühestens beim 18:00-Lauf sichtbar) ist eingetreten. **What's-New** byte-identisch (14051 Bytes), Week 34 oben, `whats-new/2026-w35` und `-w36` weiterhin **HTTP 404** — Digest-Rückstand zwei Wochen, Week 31 fehlt seit über fünf Wochen. **Platform-Release-Notes** byte-identisch, Top weiter 01.09. (Fable 5.1/Mythos 5.1, Per-Message-Effort). **Blog:** dieselben fünfzehn Slugs in gleicher Reihenfolge, Top weiter „Building commerce agents with Claude“ (28.08.); das HTML weicht zwar vom Vortagsabruf ab, aber in **genau neun Bytes**, alle im Webflow-Kommentar `<!-- Last Published: ... -->` (02.09. 21:14 -> 03.09. 17:24 UTC) — ein seitenweiter Republish ohne Inhaltsänderung. Byte-Diff ist auf dieser Seite also kein Signal, der Vergleich muss über die Slug-Liste laufen. Alle vier Quellen plus npm-Registry, Releases-API und Git-Refs per `curl -L --retry 2` im ersten Versuch, keine leeren Antworten. **Neue Einträge: 1.** — Vorheriger **Crawl 04.09. 12:00 UTC — Bestätigungslauf: keine Bewegung in allen vier Quellen.** CLI unverändert **v2.1.260** (npm-Publish 03.09. 22:32 UTC, GitHub-Release 23:48 UTC), **kein v2.1.261 bis 12:00 UTC**, `time.modified` weiter 03.09. 23:47 UTC, Tags still (`latest`=`next`=2.1.260, `stable` 2.1.236). Rhythmus: 12:00 UTC ist 05:00 Freitagmorgen Westküste — die Releases der Werktags-Serie seit 17.08. kamen fast durchweg nach 17:00 UTC (Mo 17:07, Di 17:15/22:25, Mi 21:21, Do 22:32), ein Freitags-Release wäre also frühestens beim 18:00-Lauf, sicher erst am 05.09. 06:00 sichtbar; der leere Vormittag ist kein Signal für ein Serienende. `CHANGELOG.md` unverändert: 2.1.260 -> 2.1.259 -> 2.1.258 -> 2.1.257 -> 2.1.252, die Releases-API listet dieselbe Folge (v2.1.249 und v2.1.253-256 bleiben ohne Publish). **What's-New** byte-identisch zum Vortagsabruf, Week 34 oben, `whats-new/2026-w35` und `-w36` weiterhin **HTTP 404** — der Digest-Rückstand bleibt bei zwei Wochen, Week 31 fehlt seit über fünf Wochen. **Platform-Release-Notes** byte-identisch, Top weiter 01.09. (Fable 5.1/Mythos 5.1, Per-Message-Effort). **Blog** unverändert, dieselben fünfzehn Slugs, Top weiter der Commerce-Agents-Beitrag vom 28.08., kein Beitrag vom 03. oder 04.09. Alle vier Quellen plus npm-Registry und Releases-API per `curl -L --retry 2` im ersten Versuch, keine leeren Antworten. **Neue Einträge: 0.** — Ältere Crawl-Historie in den Git-Commits.)
